...
class _LoggingWebEnginePage(QWebEnginePage):
    ...
    def createWindow(self, window_type):
        ...
        log.warning("[CAPSULE-FIX-R11] WebviewPanel.createWindow() intercepted — "
...
class WebviewPanel(QWidget):
    ...
    def force_reload_file(self, file_path: str, content: str, language: str = "plaintext"):
        ...
        if self._page_loaded:
            ...
            js_open = f"setIntendedActive({safe_path}); openFile({safe_path}, {safe_content}, {safe_lang}, {activate});"
            if is_active:
