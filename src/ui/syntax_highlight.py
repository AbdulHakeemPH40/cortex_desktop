...
# ── Color tokens — OpenCode OC-2 dark mode ──
# Reference: opencode packages/ui/src/styles/theme.css
...
C_PROPERTY    = "#ff9ae2"                   # Pink — object properties, JSON keys (OC-2 exact)
C_BUILTIN     = "#f85149"                   # Red — builtins (OpenCode: builtins are red!)
